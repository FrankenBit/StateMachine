...
namespace FrankenBit.Utilities
{
    ...
    public interface IStateTransition<out TSourceState, out TTargetState>
    {
        ...
        /// </param>
        void ButWhen( [NotNull] Func<TSourceState, bool> condition, [NotNull] IState state );

        void OnTransition( [NotNull] Action<TSourceState, TTargetState> action );
        ...
        /// </param>
        void When( [NotNull] Func<TSourceState, bool> condition );
    }
}